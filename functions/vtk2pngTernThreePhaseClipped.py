...
time_Display.RescaleTransferFunctionToDataRange(False, True)
...
# time_Display.SetRepresentationType('Surface')

# current camera placement for renderView1
renderView1.InteractionMode = '2D'
renderView1.CameraPosition = [255.5, 255.5, 10000.0]
renderView1.CameraFocalPoint = [255.5, 255.5, 0.0]
renderView1.CameraParallelScale = 64.9886580704147
...
SaveAnimation(cwd + '/images/'+projectname+'.png', renderView1, ImageResolution=[1600, 798],
